...
Command: npx gltfjsx@6.5.3 public/models/67eeaf59689407918a3354b5.glb -o src/components/Avatar.jsx -r public 
*/
...
export function Avatar(props) {
   ...
   useFrame(()=>{
       ...
       for(let i=0; i<lipsync.mouthCues.length; i++){
           ...
           if(currentAudioTime>=mouthCue.start &&  currentAudioTime<=mouthCue.end){
               ...
               nodes.Wolf3D_Head.morphTargetInfluences
                   [nodes.Wolf3D_Head.morphTargetDictionary[corresponding[mouthCue.value]]]=1;
               nodes.Wolf3D_Teeth.morphTargetInfluences
                   [nodes.Wolf3D_Head.morphTargetDictionary[corresponding[mouthCue.value]]]=1;
               break;
           }
  ...
  const { scene } = useGLTF('/models/67eeaf59689407918a3354b5.glb')
    ...
    const group = useRef();
    const {actions} = useAnimations([idle[0], angry[0], greeting[0]], group)
    ...
    useEffect(() => {
        if (actions[animation]) {
            ...
            return () => {
                if (actions[animation]) { // Ensure it exists before calling fadeOut
                    actions[animation].fadeOut(0.5);
                }
            };
        }
    }, [animation, actions]);
    // Adding actions as a dependency ensures we react to changes
...
useGLTF.preload('/models/67eeaf59689407918a3354b5.glb')
